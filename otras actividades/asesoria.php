...
<!DOCTYPE HTML>  
    <html>
        ...
        <body>
            ...
            $universidad = $facultad = $nivel = $carrera = "";
            $termino = $inicio = $numAlumnos = $obs = "";
            $universidadErr = $facultadErr = $nivelErr = $carreraErr = "";
            $termino = $inicioErr = $numAlumnosErr = $obs = "";
            ...
            if($_SERVER["REQUEST_METHOD"] == "POST"){
                ...
                if (empty($_POST["numAlumnos"])) {
                    $numAlumnosErr = "Número de alumnos es requerido";
                  } else {
                  $numAlumnos = test_input($_POST["numAlumnos"]);
                    if (! is_int("numAlumnos")) {
                        $numAlumnos = "Unicamente se permiten números enteros.";
                    }
                }
            ...
            <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                ...
                <div class="row" style="margin-top:7px;">
    				...
    				<div class="col-sm-10">
                        <input type="int" class="form-control" name="numAlumnos" /><?php echo $numAlumnosErr;?>
					</div>						
				</div>
